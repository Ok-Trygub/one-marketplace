...
export class InitialSchema1789727746208 implements MigrationInterface {
    name = 'InitialSchema1789727746208'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "orders_user_id_created_at_idx" ON "orders"  ("user_id", "created_at") `);
